...
const clerkAppearance = {
  ...
  elements: {
    ...
    card: {
      ...
      borderRadius: '20px',
      boxShadow: '0 25px 50px -12px oklch(0 0 0 / 0.5), 0 0 100px oklch(0.62 0.25 264 / 0.1)',
      padding: '2.5rem',
      position: 'relative',
      overflow: 'hidden',
      '&::before': {
        ...
        right: 0,
        height: '1px',
        background: 'linear-gradient(90deg, transparent, oklch(0.62 0.25 264 / 0.8), transparent)',
      },
    },

    // Header styling with gradient text
    headerTitle: {
      background: 'linear-gradient(135deg, oklch(0.62 0.25 264) 0%, oklch(0.64 0.24 293) 50%, oklch(0.65 0.29 350) 100%)',
      backgroundClip: 'text',
    ...
    formFieldInput: {
      ...
      '&:focus': {
        ...
        boxShadow: '0 0 0 3px oklch(0.62 0.25 264 / 0.2), 0 0 20px oklch(0.62 0.25 264 / 0.1)',
        outline: 'none',
      },
      '&::placeholder': {
    ...
    formButtonPrimary: {
      background: 'linear-gradient(135deg, oklch(0.62 0.25 264) 0%, oklch(0.64 0.24 293) 100%)',
      border: 'none',
      borderRadius: '12px',
      color: 'oklch(1 0 0)',
      cursor: 'pointer',
    ...
    userButtonAvatarBox: {
      ...
      background: 'linear-gradient(135deg, oklch(0.62 0.25 264), oklch(0.64 0.24 293)) border-box',
      WebkitMask: 'linear-gradient(oklch(1 0 0) 0 0) padding-box, linear-gradient(oklch(1 0 0) 0 0)',
    ...
    <ClerkProvider appearance={clerkAppearance}>
      <html lang="en" className="dark">
        <body
          ...
          style={{
            background: 'linear-gradient(135deg, oklch(0.13 0.02 265) 0%, oklch(0.21 0.08 275) 50%, oklch(0.30 0.10 280) 100%)',
        ...
        >
          ...
          <div className="fixed inset-0 overflow-hidden pointer-events-none">
            <div
              ...
              style={{
                background: 'radial-gradient(circle, oklch(0.62 0.25 264 / 0.1) 0%, transparent 70%)',
            ...
            <div
              ...
              style={{
                background: 'radial-gradient(circle, oklch(0.64 0.24 293 / 0.1) 0%, transparent 70%)',
