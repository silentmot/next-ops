  ...
  aurora: {
    ...
    colors: {
      ...
      gradients: {
        ...
        rainbow: 'linear-gradient(135deg, #00f5ff 0%, #7c3aed 50%, #06ffa5 100%)',
      }
    }
  },
  ...
  nebula: {
    ...
    colors: {
      ...
      gradients: {
        ...
        rainbow: 'linear-gradient(135deg, #ff6b6b 0%, #4ecdc4 50%, #45b7d1 100%)',
      }
    }
  },
  ...
  void: {
    ...
    colors: {
      ...
      gradients: {
        ...
        rainbow: 'linear-gradient(135deg, #ffffff 0%, #a1a1aa 50%, #71717a 100%)',
      }
    }
  }
}
...
export function ThemeProvider({
  ...
  useEffect(() => {
    const savedVariant = localStorage.getItem('ops-theme-variant') as ThemeVariant
...
export function useThemeStyles() {
  ...
  return {
    ...
    // Animation styles
    transition: (duration: keyof typeof tokens.animation.duration = 'normal') => ({
